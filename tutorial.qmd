...
::: panel-tabset
### 1. Simple (no random effects on location and scale components)
...
### 2. Heteroscedastic meta-regression
...
On the response-ratio scale, these estimates correspond approximately to organic yields of \exp(-0.26) $\approx$ 0.77 (about 23\% lower than conventional) under animal-based fertilisers, versus \exp(-0.26 - 0.15) $\approx$ 0.66 (about 34\% lower) under plant-based fertilisers.
...
### 2 and 3. Random effects/Correlated random effects in location and scale components
...
# 
#       AIC       BIC    logLik -2*log(L)  df.resid 
#     836.5     855.3    -413.3     826.5       313 
# 
# Random effects:
# 
# Conditional model:
#  Groups   Name             Variance Std.Dev. Corr                                            
#  study_ID (Intercept)      0.05500  0.2345                                                   
#  g        effect_size_ID33 0.11583  0.3403                                                   
#           effect_size_ID34 0.29264  0.5410   0.00                                            
#           effect_size_ID35 0.31983  0.5655   0.00 0.00                                       
#           effect_size_ID36 0.32986  0.5743   0.00 0.00 0.00                                  
...
# Conditional model:
#                          Estimate Std. Error z value Pr(>|z|)
# (Intercept)               0.06085    0.07014   0.868    0.386
# Org.fertilizer.typeplant -0.14843    0.10916  -1.360    0.174
# 
# Dispersion model:
#                          Estimate Std. Error z value Pr(>|z|)
# (Intercept)                -2.506      1.758  -1.425    0.154
# Org.fertilizer.typeplant    2.150      1.762   1.220    0.222
